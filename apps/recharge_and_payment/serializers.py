...
class PaymentSerializer(BaseAlzajilSerializer):
    ...
    MT = serializers.IntegerField(required=False, help_text="نوع المشترك: 0 (مفتوح)، 1 (مسبق الدفع)، 2 (فوترة)")
    REF = serializers.CharField(max_length=10, required=False, help_text="رقم مرجع فريد من الوكيل")
...
class OfferManagementSerializer(BaseAlzajilSerializer):
    """
    لرموز الإجراء AC 4002-4007 (إدارة العروض)
    """
    AC = serializers.IntegerField(help_text="رمز الإجراء: 4002-4007")
