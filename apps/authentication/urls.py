...
from .views import LoginView, RegisterView, UserListView, UserUpdateView, UserDeleteView, UserDetailView, KYCSubmissionView, AdminPasswordResetView, NotificationListView, MarkNotificationsReadView
